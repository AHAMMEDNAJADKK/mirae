...
export const MonographCard = ({ project, onSelect }) => (
  ...
  >
    ...
    <div className="relative w-full aspect-[16/10] overflow-hidden rounded-lg bg-neutral-900 mb-5">
      ...
      <span className="absolute top-3 left-3 bg-black/70 backdrop-blur-md text-xs font-mono tracking-widest text-neutral-200 px-3 py-1 rounded-full border border-white/15">
        {project.id}
      </span>
      <span className="absolute top-3 right-3 bg-black/70 backdrop-blur-md text-xs font-mono tracking-widest text-amber-300 px-3 py-1 rounded-full border border-white/15 uppercase font-medium">
        {project.category}
      </span>
    </div>

    {/* Project Meta Details */}
    <div className="flex items-center justify-between text-xs font-mono text-amber-400 font-medium tracking-wider mb-2">
    ...
    <p className="text-xs font-semibold text-amber-400/90 mb-2.5 tracking-wide">{project.tagline}</p>
    <p className="text-xs sm:text-sm text-neutral-300 font-normal line-clamp-3 mb-6 leading-relaxed">
      {project.description}
    </p>
    ...
    <div className="mt-auto flex items-center justify-between pt-4 border-t border-neutral-800/80">
      <button 
        ...
        className="text-xs font-mono text-neutral-200 hover:text-white transition-colors tracking-widest flex items-center gap-1.5 font-medium"
      >
      ...
      <button 
        ...
        className="text-xs font-mono text-amber-400 hover:text-amber-300 transition-colors tracking-widest flex items-center gap-1 font-medium"
      >
    ...
    <section id="projects" className="relative w-full bg-[#080808] py-16 sm:py-24 md:py-32 px-5 sm:px-10 md:px-16 lg:px-20 text-[#f4f3ef] border-t border-white/[0.08]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-12 border-b border-white/[0.08] pb-6 sm:pb-8">
          <div>
            <span className="text-xs font-mono-subtle text-white/60 uppercase mb-2 sm:mb-3 block tracking-[0.3em] font-medium">
          ...
          {/* Project Counter */}
          <div className="mt-4 md:mt-0 text-xs font-mono-subtle text-white/50 tracking-widest uppercase">
          ...
          {FILTERS.map((filter) => {
            ...
            return (
              <button
                ...
                className={`px-4 sm:px-5 py-2 text-[11px] sm:text-xs font-mono-subtle tracking-wider sm:tracking-widest uppercase transition-all duration-300 border rounded-sm ${
                  isActive
        ...
        <div className="mt-14 sm:mt-20 border border-white/[0.12] bg-gradient-to-b from-[#121212] to-[#0a0a0a] p-6 sm:p-10 md:p-14 relative overflow-hidden rounded-xl shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 sm:gap-8">
            <div className="max-w-2xl">
              <div className="flex items-center space-x-2 text-xs font-mono-subtle text-amber-400 font-medium tracking-[0.3em] uppercase mb-2 sm:mb-3">
              ...
              <p className="text-xs sm:text-sm font-normal text-neutral-300 mt-3 sm:mt-4 leading-relaxed max-w-xl">
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-6 mt-5 sm:mt-6 text-xs font-mono-subtle text-white/60">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 shrink-0">
              <a
                ...
                className="inline-flex items-center justify-center space-x-2.5 px-6 sm:px-8 py-3 sm:py-3.5 text-xs font-mono-subtle font-medium tracking-[0.2em] uppercase border border-white/30 text-white hover:border-white hover:bg-white/5 transition-all duration-300 rounded-sm"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center space-x-2.5 px-6 sm:px-8 py-3 sm:py-3.5 text-xs font-mono-subtle tracking-[0.2em] uppercase bg-white text-black font-semibold hover:bg-[#e6e4dd] transition-all duration-300 shadow-lg rounded-sm"
              >
