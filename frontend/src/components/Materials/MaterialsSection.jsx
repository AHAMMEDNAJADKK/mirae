...
export default function MaterialsSection() {
  ...
  useEffect(() => {
    ...
    // Mobile Phones (< 768px): Pin section so each material gets dedicated scroll distance
    // Each material gets ~innerHeight * 0.55 of scroll, 4 materials = innerHeight * 2.2
