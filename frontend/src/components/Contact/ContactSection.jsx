  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col justify-between min-h-[500px]">
        ...
        <div className="pt-8 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-pencrow text-white/60">
          
          {/* Nav Links */}
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-7">
            <button onClick={() => scrollTo('hero')} className="hover:text-white transition-colors uppercase py-1 font-pencrow font-medium tracking-wider">
              Home
            </button>
            <button onClick={() => scrollTo('about')} className="hover:text-white transition-colors uppercase py-1 font-pencrow font-medium tracking-wider">
              About
            </button>
            <button onClick={() => scrollTo('exterior-layers')} className="hover:text-white transition-colors uppercase py-1 font-pencrow font-medium tracking-wider">
              Exterior
            </button>
            <button onClick={() => scrollTo('interior')} className="hover:text-white transition-colors uppercase py-1 font-pencrow font-medium tracking-wider">
              Interior
            </button>
            <button onClick={() => scrollTo('materials')} className="hover:text-white transition-colors uppercase py-1 font-pencrow font-medium tracking-wider">
              Materials
            </button>
            <button onClick={() => scrollTo('contact')} className="hover:text-white transition-colors uppercase py-1 font-pencrow font-medium tracking-wider">
              Contact
            </button>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <a 
              ...
              className="hover:text-white transition-colors group inline-flex items-center space-x-2 font-pencrow font-medium tracking-wider"
            >
