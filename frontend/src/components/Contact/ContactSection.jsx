...
export default function ContactSection() {
  ...
  return (
    <footer 
      id="contact" 
      className="relative w-full bg-[#050505] text-[#f4f3ef] pt-12 sm:pt-20 md:pt-24 pb-[max(2rem,calc(env(safe-area-inset-bottom)+1.5rem))] sm:pb-12 px-4 sm:px-8 md:px-14 lg:px-20 border-t border-white/[0.08]"
    >
      <div className="max-w-7xl mx-auto flex flex-col justify-between min-h-[380px] sm:min-h-[480px]">
        ...
        <div className="w-full text-center my-4 sm:my-8 md:my-10 flex flex-col items-center justify-center">
          <img 
            ...
            alt="MIRAE" 
            className="h-[clamp(2.75rem,5.5vw,5.5rem)] w-auto object-contain mx-auto mb-3 sm:mb-6" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 my-6 sm:my-10 md:my-12 items-end">
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-pencrow text-white/60">
          ...
          {/* Nav Links */}
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2.5 sm:gap-6 md:gap-7">
